...
public class UserService implements UserDetailsService {
	...
	public boolean checkExist(Users s) {
		...
		*/
		public void add(Users s, String siteURL) throws
		...
		private void sendVerificationEmail(Users user, String siteURL)
				...
				String fromAddress = "antoniocalzado02@gmail.com";
				String senderName = "Papi tu no lo esta haciendo bien";
				String subject = "Please verify your registration";
				String content = "Dear [[user]],<br>" + "Please click the link below to verify your registration:<br>"+ "<h3><a href=\"[[URL]]\"target=\"_self\">VERIFY</a></h3>" + "Thank you,<br>" + "Your company name.";
		...
		public boolean enableUser(String code, String ursername) {
			Users u=repositorio.findById(ursername).orElse(null);
